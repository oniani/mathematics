...
by a path in $SC^2(Y \times Y)$. Therefore, every configuration is attainable from every other one and thus, the AVGs
$R_1$ and $R_2$ are freely transportable in $SC^2(Y \times Y)$.
