...
\begin{definition}
\cite{8} Given points $x$ and $y$ of the space $X$, a \textbf{path} in $X$ from $x$ to $y$ is a 
...
\begin{thebibliography}{00}
    \bibitem{1} C. Adams and R. Fransoza, ``Introduction to Topology'', p. 105.
    \bibitem{2} C. Adams and R. Fransoza, ``Introduction to Topology'', pp. 105 -- 106.
    \bibitem{3} J. R. Munkres, ``Topology'', Second Edition, p. 76
    \bibitem{4} J. R. Munkres, ``Topology'', Second Edition, p. 76
    \bibitem{5} J. R. Munkres, ``Topology'', Second Edition, p. 102
    \bibitem{6} J. R. Munkres, ``Topology'', Second Edition, p. 105
    \bibitem{7} J. R. Munkres, ``Topology'', Second Edition, p. 148
    \bibitem{8} J. R. Munkres, ``Topology'', Second Edition, p. 155
\end{thebibliography}
\end{center}
