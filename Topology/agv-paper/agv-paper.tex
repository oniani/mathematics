...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=1.5]
        ...
        % Diagonal
        \draw [very thick, dotted] (0, 0) -- (2, 2);
        % Points
        \node [left] at (0, 2) {$l$};
        \node [right] at (2, 0) {$l$};
        \node [left] at (0, 0) {$0$};
        ...
        % 0.4, 0.4
        \draw [very thick, dotted] (0, 0.4) -- (0.4, 0.4);
        \draw [very thick, dotted] (0.4, 0) -- (0.4, 0.4);
        % 0.9, 0.9
        \draw [very thick, dotted] (0, 0.9) -- (0.9, 0.9);
        \draw [very thick, dotted] (0.9, 0) -- (0.9, 0.9);
        % 1.6, 1.6
        \draw [very thick, dotted] (0, 1.6) -- (1.6, 1.6);
        \draw [very thick, dotted] (1.6, 0) -- (1.6, 1.6);
    \end{tikzpicture}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=1.5]
        ...
        \draw [black, very thick, dash pattern=on 2pt off 3pt] (0, 0) -- (2, 2);
...
\begin{figure}[H]
    ...
    % Grey Filling
    \draw [fill=gray] (0, 0) -- (3, 3) -- (6, 3) -- (3, 0);
    % Sides
